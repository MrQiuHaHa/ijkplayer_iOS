...
#define FFMPEG_CONFIGURATION "--enable-gpl --enable-encoder=libx264 --enable-libx264 --enable-nonfree --enable-runtime-cpudetect --disable-gray --disable-swscale-alpha --disable-programs --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-doc --disable-htmlpages --disable-manpages --disable-podpages --disable-txtpages --disable-avdevice --enable-avcodec --enable-avformat --enable-avutil --enable-swresample --enable-swscale --disable-postproc --enable-avfilter --disable-avresample --enable-network --disable-dxva2 --disable-vaapi --disable-vdpau --enable-encoders --disable-decoders --enable-decoder=aac --enable-decoder=aac_latm --enable-decoder=flv --enable-decoder=h263 --enable-decoder=h263i --enable-decoder=h263p --enable-decoder=h264 --enable-decoder='mp3*' --enable-decoder=vp6 --enable-decoder=vp6a --enable-decoder=vp6f --enable-decoder=hevc --enable-decoder=mpeg4 --enable-decoder=amr_nb --disable-hwaccels --disable-muxers --enable-muxer=mpegts --enable-muxer=mp4 --disable-demuxers --enable-demuxer=aac --enable-demuxer=concat --enable-demuxer=data --enable-demuxer=flv --enable-demuxer=hls --enable-demuxer=latm --enable-demuxer=live_flv --enable-demuxer=loas --enable-demuxer=m4v --enable-demuxer=mov --enable-demuxer=mp3 --enable-demuxer=mpegps --enable-demuxer=mpegts --enable-demuxer=mpegvideo --enable-demuxer=hevc --disable-parsers --enable-parser=aac --enable-parser=aac_latm --enable-parser=h263 --enable-parser=h264 --enable-parser=hevc --enable-bsfs --disable-bsf=mjpeg2jpeg --disable-bsf=mjpeg2jpeg --disable-bsf=mjpega_dump_header --disable-bsf=mov2textsub --disable-bsf=text2movsub --enable-protocols --enable-protocol=async --disable-protocol=bluray --disable-protocol=ffrtmpcrypt --enable-protocol=ffrtmphttp --disable-protocol=gopher --disable-protocol='librtmp*' --disable-protocol=libssh --disable-protocol=mmsh --disable-protocol=mmst --disable-protocol='rtmp*' --enable-protocol=rtmp --enable-protocol=rtmpt --disable-protocol=rtp --disable-protocol=sctp --disable-protocol=srtp --disable-protocol=unix --disable-devices --enable-filters --disable-iconv --enable-cross-compile --enable-pic --disable-debug --enable-openssl --disable-bsf=eac3_core --enable-cross-compile --disable-stripping --arch=arm64 --target-os=darwin --enable-static --disable-shared --enable-pic --enable-neon --enable-optimizations --disable-debug --enable-small --prefix=/Users/qiujunrong/Desktop/player/ijkplayer-ios/ios/build/ffmpeg-arm64/output --enable-openssl --cc='xcrun -sdk iphoneos clang' --extra-cflags=' -arch arm64 -miphoneos-version-min=8.0 -fembed-bitcode -I/Users/qiujunrong/Desktop/player/ijkplayer-ios/ios/build/openssl-arm64/output/include -I/usr/local/include' --extra-cxxflags=' -arch arm64 -miphoneos-version-min=8.0 -fembed-bitcode -I/Users/qiujunrong/Desktop/player/ijkplayer-ios/ios/build/openssl-arm64/output/include -I/usr/local/include' --extra-ldflags=' -arch arm64 -miphoneos-version-min=8.0 -fembed-bitcode -L/usr/local/lib -arch arm64 -miphoneos-version-min=8.0 -fembed-bitcode -I/Users/qiujunrong/Desktop/player/ijkplayer-ios/ios/build/openssl-arm64/output/include -L/Users/qiujunrong/Desktop/player/ijkplayer-ios/ios/build/openssl-arm64/output/lib -lssl -lcrypto'"
#define FFMPEG_LICENSE "nonfree and unredistributable"
#define CONFIG_THIS_YEAR 2018
#define FFMPEG_DATADIR "/Users/qiujunrong/Desktop/player/ijkplayer-ios/ios/build/ffmpeg-arm64/output/share/ffmpeg"
#define AVCONV_DATADIR "/Users/qiujunrong/Desktop/player/ijkplayer-ios/ios/build/ffmpeg-arm64/output/share/ffmpeg"
...
#define CONFIG_IJKLIVEDASH_DEMUXER 0
